...
function QuestionOne({GoNextStep, goDashboardPage, data, assessment, setAssessment}) {
        ...
        <>
            <div className=''>
                ...
                <div className='btn_block'>
                    <Link to="/guidance-counselor" className='btn submit_btn back-button' onClick={goDashboardPage}> Back </Link>
