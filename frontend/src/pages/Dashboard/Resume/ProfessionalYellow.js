...
const ProfessionalYellow = ({ resume, user }) => {
    ...
    const Header = ({ data }) => (
        <div className='user_info_content section'>
            <div className='uic_default_content section'>
                ...
                <div className='flow_left_content'>
            ...
            <div className='uic_default_right_content section'>
                ...
                <div className='flow_right_content'>
    ...
    const [dom, setDom] = useState(
        <div id='resumeContent' ref={printRef}>
            <div className="new-page-wrapper a4 mb-3 professional_resume_page" style={{ pageBreakBefore: 'always',pageBreakAfter: 'always'}}>
...
export default ProfessionalYellow;
