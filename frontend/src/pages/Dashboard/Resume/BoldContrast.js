...
const BoldContrast = ({ resume, user }) => {
    ...
    const [dom, setDom] = useState(
        <div id='resumeContent' ref={printRef}>
            <div className="new-page-wrapper a4 mb-3 contrast_resume_page" style={{ pageBreakBefore: 'always',pageBreakAfter: 'always'}}>
                <div  className={`resume_page_block`}>
                    ...
                    <div className='user_info_content section'>
                        <div className='uic_default_content section'>
                            <div className='contrast_left_bg'>
