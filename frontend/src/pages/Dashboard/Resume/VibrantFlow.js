...
const VibrantFlow = ({ resume, user }) => {
    ...
    const [dom, setDom] = useState(
        <div id='resumeContent' ref={printRef}>
            <div className="new-page-wrapper a4 mb-3 vibrantflow_resume_page" style={{ pageBreakBefore: 'always',pageBreakAfter: 'always'}}>
