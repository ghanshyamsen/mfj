...
const CreativeGrid = ({ resume, user }) => {
    ...
    const Header = ({ data }) => (
        <div className='user_block'>
            <div className='user_infomation'>
                <p className='user_name'><span>{data.name}</span></p>
    ...
    const [dom, setDom] = useState(
        <div id='resumeContent' ref={printRef}>
            <div className="new-page-wrapper a4 mb-3 creative_grid_resume_page" style={{ pageBreakBefore: 'always',pageBreakAfter: 'always'}}>
                <div  className={`resume_page_block`}>
                    ...
                    <div className='user_info_content section '>
                        ...
                        <div className='uic_default_right_content section'>
                            ...
                            <References key="references" data={resume.references} position="right" />
