...
function CandidatesAnalytics({analytics, job, loadingSkeleton}){
    return(
        <>
            ...
            <div className='analy_elements_parent_section'>
              ...
              <div className="w-100">
                <Row>
                  <Col md={6}>
                    {loadingSkeleton ?
                      <div className="analy_elements_outer_block  h-auto">
                  ...
                  <Col md={6}>
                    {loadingSkeleton ?
                      <div className="analy_elements_outer_block  h-100">
