...
function JobReview() {
    ...
    return(
        <>
            ...
            <div className="job_review_page common_background_block">

                <div className="common_card mb-3">

                    <h1 className="d_title"> Review </h1>
                    {/* General Information */}
                ...
                <div className='jobopening_job common_card mb-3'>
                    <button type="button" className="btn submit_btn mb-0 mt-0" onClick={()=>{jobOpenClosed(true)}}> Post </button>
                    <Link to={`/post-job/${Id}`} className='btn submit_btn mb-0 mt-3'> Edit</Link>
