...
function QuestionFour({GoBackStep, GoNextStep, data, onUpdate, objective, resume, fetchResume}) {
    ...
    const handleClickNext = () => {
        ...
        const raw = JSON.stringify({
            question_four_ans: selectedOption
        });
    ...
    const options = [
        { id: 'one', label: objective[3].option_one },
        { id: 'two', label: objective[3].option_two },
        { id: 'three', label: objective[3].option_three },
        { id: 'four', label: objective[3].option_four }
    ];
    ...
    useEffect(()=>{
        setSelectedOption(resume.question_four_ans);
    },[resume]);
        ...
        <>
            <div className=''>
                <div className="rim_content">
                    <h1 className="rim_heading">{objective[3].question}</h1>
                </div>
