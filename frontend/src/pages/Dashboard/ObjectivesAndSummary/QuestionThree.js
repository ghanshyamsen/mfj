...
function QuestionThree({GoBackStep, GoNextStep, data, onUpdate, objective, resume, fetchResume}) {
    ...
    const handleClickNext = () => {
        ...
        const raw = JSON.stringify({
            question_three_ans: selectedOption
        });
    ...
    const options = [
        { id: 'one', label: objective[2].option_one },
        { id: 'two', label: objective[2].option_two },
        { id: 'three', label: objective[2].option_three },
        { id: 'four', label: objective[2].option_four }
    ];
    ...
    useEffect(()=>{
        setSelectedOption(resume.question_three_ans);
    },[resume]);
        ...
        <>
            <div className=''>
                <div className="rim_content">
                    <h1 className="rim_heading">{objective[2].question}</h1>
                </div>
