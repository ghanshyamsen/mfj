...
function QuestionTwo({GoBackStep, GoNextStep, data, onUpdate, objective, resume, fetchResume}) {
    ...
    const handleClickNext = () => {
        ...
        const raw = JSON.stringify({
            question_two_ans: selectedOption
        });
    ...
    const options = [
        { id: 'one', label: objective[1].option_one },
        { id: 'two', label: objective[1].option_two },
        { id: 'three', label: objective[1].option_three },
        { id: 'four', label: objective[1].option_four }
    ];
    ...
    useEffect(()=>{
        setSelectedOption(resume.question_two_ans);
    },[resume]);
        ...
        <>
            <div className=''>
                <div className="rim_content">
                    <h1 className="rim_heading">{objective[1].question}</h1>
                </div>
