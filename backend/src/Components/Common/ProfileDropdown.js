...
//import images
import avatar1 from "../../assets/images/users/boy.png";
...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        if (sessionStorage.getItem("authUser")) {
            ...
            setUserName(process.env.REACT_APP_DEFAULTAUTH === "fake" ? obj.username === undefined ? user.first_name ? user.first_name : obj.data.name : "Admin" || "Admin" :
