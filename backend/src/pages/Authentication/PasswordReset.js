...
const PasswordReset = () => {
  const { id: resetKey } = useParams();
  const dispatch = useDispatch();
  const history = useNavigate();

  document.title = "Create New Password | " + process.env.REACT_APP_SITE_NAME;

  const [passwordShow, setPasswordShow] = useState(false);
  const [confrimPasswordShow, setConfrimPasswordShow] = useState(false);
  const [idx, setidx] = useState(resetKey);
  ...
  }, [dispatch, idx, submitSuccess, history,]);
                  ...
                  <CardBody className="p-4">
                    ...
                    <div className="p-2">
                      ...
                      >
                        ...
                        <Input type="hidden" name="idx" value={validation.values.idx} />
                        <div
                          id="password-contain"
