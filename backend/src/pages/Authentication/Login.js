...
const Login = (props) => {
    ...
    document.title = "SignIn | "+process.env.REACT_APP_SITE_NAME;
    return (
        <React.Fragment>
            <ParticlesAuth>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">{process.env.REACT_APP_SITE_NAME}</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to {process.env.REACT_APP_SITE_NAME}.</p>
                                        </div>
                                        {errorMsg && errorMsg ? (<Alert color="danger"> Invalid credentials, please try again. </Alert>) : null}
