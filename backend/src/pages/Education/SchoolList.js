...
const Schools = () => {
  ...
  document.title ="Schools | "+process.env.REACT_APP_SITE_NAME;
  ...
  const fetchData = async () => {
    try {
      const response = await api.get(`${process.env.REACT_APP_API_URL}/schools/get`);
  ...
  const handleConfirm = async () => {
    ...
    const response = await api.delete(`${process.env.REACT_APP_API_URL}/schools/delete/${delId}`);
        ...
        accessor: (cellProps) => {
          return (
            <div className="hstack gap-3 flex-wrap">
              <Link to={"/education/manage-school/"+cellProps.id} className="link-success fs-15"><i className="ri-edit-line"></i></Link>
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Schools List" pageTitle="Schools" />
          <Row>
            <Col xs={12}>
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <Link to={"/education/manage-school"}>
                    <Button className="btn-border" outline><i className="ri-add-line"></i> Add School</Button>
                  </Link>
