...
class VolunteerSkills {
  ...
  async get(req, res) {
    ...
    try{
      ...
      if(key){
        const getSkill = await VolunteerSkillModel.findById(key);
        ...
        const getSkills = await VolunteerSkillModel.find({}, 'title updatedAt').then(function(skills){
  ...
  async create(req, res){
    ...
    try{
      ...
      const create = await VolunteerSkillModel.create(postData);
  ...
  async update(req, res) {
    ...
    try{
      ...
      const update = await VolunteerSkillModel.findOneAndUpdate(
        {_id: key},
        {$set: postData},
        {new: true}
      );
  ...
  async delete(req, res) {
    try{
      ...
      await VolunteerSkillModel.findOneAndDelete({ _id: key });
